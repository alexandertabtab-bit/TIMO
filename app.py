...
st.set_page_config(page_title="Life Chart Tracker", layout="wide")
...
tab_entry, tab_chart, tab_patterns, tab_summary = st.tabs(
    ["Daily Entry", "Life Chart", "Episode Patterns", "Doctor Summary"]
)
